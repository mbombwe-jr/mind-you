...
impl TunDevice for Bridge {
    ...
    type RecvFut<'a> = Pin<Box<dyn Future<Output=Result<usize>> + Send + Sync + 'a>>;
...
#[no_mangle]
pub extern "system" fn if_to_fubuki(handle: *const Handle, packet: *const u8, len: usize) {
...
#[no_mangle]
pub extern "system" fn fubuki_start(
...
#[no_mangle]
pub extern "system" fn fubuki_block_on(handle: *mut Handle,  error: *mut c_char) -> i32 {
...
#[no_mangle]
pub extern "system" fn fubuki_stop(handle: *mut Handle) {
    let _ = unsafe { Box::from_raw(handle) };
}

#[no_mangle]
pub extern "system" fn fubuki_version() -> *const c_char {
    const VERSION: &str = concat!(env!("CARGO_PKG_VERSION"), '\0');
    VERSION.as_ptr() as *const c_char
}

#[no_mangle]
pub extern "system" fn interfaces_info(handle: *const Handle, info_json: *mut c_char) {
    let handle = unsafe { &*handle };
