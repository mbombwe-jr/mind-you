...
import ChannelHeader from "../CourseHeader";
...
const CourseArea = () => {
  const { messages, currentView, currentCourse, searchTerm, currentTab } = useCourseContext();
            ...
            {messages.length === 0 ? (
              <div className="bg-accent/50 px-6 py-4 mb-4">
                <h2 className="text-lg font-semibold text-foreground mb-1">
                    Welcome to <span className="text-primary">{currentCourse?.name || 'Course'}!</span> 🧠
                </h2>
