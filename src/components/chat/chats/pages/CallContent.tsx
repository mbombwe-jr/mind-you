...
const CallContent = ({ isGroup = false }) => {
  const [users, setUsers] = useState(dummyUsers.slice(0, isGroup ? dummyUsers.length : 2));
  ...
  return (
    <div className="flex flex-col h-screen min-h-0 justify-between">
